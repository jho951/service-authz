...
- `io.github.jho951.platform:platform-governance-bom:2.0.2`
- `io.github.jho951.platform:platform-governance-starter`
- `io.github.jho951.platform:platform-security-bom:2.0.5`
- `io.github.jho951.platform:platform-security-starter`
- `io.github.jho951.platform:platform-security-governance-bridge:1.0.3`
...
- local/test 호환을 위해 `LEGACY_SECRET`, `HYBRID` 모드에서 `X-Internal-Request-Secret`을 지원합니다.
...
- audit delivery uses `platform-governance` `AuditLogRecorder`/`AuditEntry`
...
기대 버전:
- `platform-security-starter:2.0.5`
- `platform-governance-starter:2.0.2`
