package com.authzservice.app.spring;
...
public class AuthzPlatformOperationalConfiguration {

    @Bean
    public PlatformRateLimitPort platformSecurityRateLimiter(
            StringRedisTemplate redisTemplate,
            @Value("${PLATFORM_SECURITY_RATE_LIMIT_REDIS_PREFIX:platform-security:rate-limit:authz-service:}")
            String keyPrefix
    ) {
